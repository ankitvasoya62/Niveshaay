    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <a class="btn btn-primary" href="{{ route('admin.our-clients') }}">Back</a>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Home</a></li>
                            <li class="breadcrumb-item active">Trash Our Clients</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Trash Our Clients</h3>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                href="{{route('admin.our-client.restore',$client->id)}}" class="btn btn-warning" title="Restore"><i class="fas fa-undo"></i>
                                                </a>
                                                <a onclick="return confirm('Are you sure you want to delete this entry?')"
                                                    href="{{route('admin.our-client.permanent-delete',$client->id)}}" class="btn btn-danger" title="Delete"><i class="fas fa-trash"></i>
                                                </a>
                                            </td>
