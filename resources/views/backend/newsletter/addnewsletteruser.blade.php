          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Add Newsletter Users</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="card-title">Add Newsletter Users</div>
                        </div>
                        <form id="quickForm" method="POST" action="{{route('admin.newsletter.store.users')}}" enctype="multipart/form-data">@csrf
                        <div class="card-body">
