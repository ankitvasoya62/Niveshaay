                ...
                <form method="POST" action="{{ route('store.companysubscription-details')}}" id="subscription-form">@csrf
                    <div class="form-outer-wrapper">
                        ...
                        <div class="form-group half-width">
                            ...
                            <select name="state" class="custom-dropdown form-control" required>
                                ...
                                @foreach ($states as $key=>$value )
                                    <option value="{{ $value }}" @if ($value == $subscription_details->state)
                                         selected
                                    @endif>{{ $value }} </option>
                                @endforeach
                            </select>	                    
                            ...
                            <div class="custom-radio-wrapper">
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="is_demat_account" name="is_demat_account" type="radio" value="1" @if($subscription_details->is_demat_account == 1) checked @endif>		                    
                                        <label for="is_demat_account">Yes</label>
                                    </div>
                                </div>
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="is_demat_account1" name="is_demat_account" type="radio" value="0" @if($subscription_details->is_demat_account == 0) checked @endif>		                    
                                        <label for="is_demat_account1">No</label>
                                    </div>
                                </div>
                        ...
                        <div class="form-group half-width">
                            ...
                            <input id="demat_account_no" name="demat_account_no" type="text" class="form-control" placeholder="Enter DEMAT account no. " value="{{ $subscription_details->demat_account_no }}">		                    
                        ...
                        <div class="form-group has-date-picker half-width">
                            <label for="date_of_incorporation">Date of Incorporation
                                ...
                                <input id="date_of_incorporation" name="date_of_incorporation" type="text" class="form-control datepicker" placeholder="Enter Date of Incorporation" autocomplete="off" value="{{ date('d/m/Y',strtotime($subscription_details->date_of_incorporation))}} ">		                    
                        ...
                        <div class="form-group half-width">
                            ...
                            <input id="legal_status" name="legal_status" type="text" class="form-control" placeholder="Enter Legal Status" value="{{ $subscription_details->legal_status }}">		                    
                            @error('legal_status')
                                <span class="error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group has-radio-group">
                            ...
                            <div class="custom-radio-wrapper">
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="less5" name="number_of_years_since_registration" type="radio" value="1" @if($subscription_details->number_of_years_since_registration == '1') checked @endif>		                    
                                        <label for="less5">less than 5 years</label>
                                    </div>
                                </div>
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="5-10" name="number_of_years_since_registration" type="radio" value="2" @if($subscription_details->number_of_years_since_registration  == '2') checked @endif>		                    
                                        <label for="5-10">5-10 years</label>
                                    </div>
                                </div>
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="10plus" name="number_of_years_since_registration" type="radio" value="3" @if($subscription_details->number_of_years_since_registration  == '3') checked @endif>		                    
                        ...
                        <div class="form-group has-radio-group">
                            ...
                            <div class="custom-radio-wrapper">
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="less10" name="average_profit" type="radio" value="1" @if($subscription_details->average_profit  == '1') checked @endif>		                    
                                        <label for="less10">less than Rs. 10 lakhs</label>
                                    </div>
                                </div>
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="10-25" name="average_profit" type="radio" value="2" @if($subscription_details->average_profit == '2') checked @endif>		                    
                                        <label for="10-25">Rs. 10-25 lakhs</label>
                                    </div>
                                </div>
                                <div class=" custom-radio-btn">
                                    <div class="radio-btn-inner">
                                        <input id="25plus" name="average_profit" type="radio" value="3" @if($subscription_details->average_profit == '3') checked @endif>		                    
