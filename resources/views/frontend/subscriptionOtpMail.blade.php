                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="small-font" style="font-family: Arial, Helvetica Neue, Helvetica, sans-serif;font-size: 31px;color: #000000;font-weight: 700;line-height: 1.2;">Verify One Time Password</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="30" class="mble-height"></td>
                                                            </tr>
                                                ...
                                                <td>
                                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" style="font-family: Verdana;color:#000;font-size: 14px;line-height: 1.2;">Your OTP for Subscription Verification is</td>
                                                            </tr>
                                                            <tr>
                                                                <td height="15"></td>
                                                            </tr>
                                                            <tr>
                                                                <td>
                                                                     <table cellpadding="0" cellspacing="0" border="0" width="205" align="center" style="width:205px;">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="font-family: Verdana;color:#83b645;font-size: 31px;line-height: 1.2;font-weight: 700;text-align: center;letter-spacing:5px">{{$otp}}</td>
